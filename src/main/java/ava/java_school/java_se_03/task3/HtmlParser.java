package ava.java_school.java_se_03.task3;
...
public class HtmlParser {
    ...
    private Path pathToFile = Paths.get("src/main/java/ava/java_school/java_se_03/task3/Java.SE.03.Information_handling_task_attachment.html");
