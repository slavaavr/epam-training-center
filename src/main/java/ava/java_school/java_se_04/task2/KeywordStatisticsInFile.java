...
public class KeywordStatisticsInFile {
    private List<ava.java_school.java_se_04.task1.KeywordStatisticsInFile.KeywordCount> keywordCountList;

    public KeywordStatisticsInFile() {
        keywordCountList = new ArrayList<>();
    }

    public List<ava.java_school.java_se_04.task1.KeywordStatisticsInFile.KeywordCount> getKeywordCountList() {
    ...
    public void parse(Path pathToFile, Path pathToKeywords) {
        ...
        try (BufferedReader brForKeywords = new BufferedReader(new FileReader(pathToKeywords.toString()));
            ...
            while ((line = brForFile.readLine()) != null) {
                for (ava.java_school.java_se_04.task1.KeywordStatisticsInFile.KeywordCount keywordCount : keywordCountList) {
    ...
    private void initKeywordCountList(String words) {
        ...
        for (String string : strings) {
            keywordCountList.add(new ava.java_school.java_se_04.task1.KeywordStatisticsInFile.KeywordCount(string, 0));
        }
    }
