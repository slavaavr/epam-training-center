...
public class HtmlParser {
    ...
    private Path pathToFile = Paths.get("java_school/src/main/java/ava/java_se_03/task3/Java.SE.03.Information_handling_task_attachment.html");
