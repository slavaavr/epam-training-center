package ava.java_se_08.task1;

import ava.java_se_08.task1.entity.Person;
...
public class Main {
    private static final String SCHEMA = "java_school/src/main/java/ava/java_se_08/task1/schema.sql";
